...
setup(
  ...
  url = 'https://github.com/Dhruv-os-23/Topsis-Garv-102117114',   # Provide either the link to your github or to your website
  download_url = 'https://github.com/Dhruv-os-23/Topsis-Garv-102117114/archive/refs/tags/1.0.4.tar.gz',    # I explain this later on
